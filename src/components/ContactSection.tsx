      ...
      <div className="mx-auto max-w-7xl px-3 sm:px-6 lg:px-8">
        ...
        <div className="mt-10 sm:mt-14 lg:mt-16 grid grid-cols-1 gap-8 lg:grid-cols-12">
          ...
          <div className="lg:col-span-5 space-y-8">
            ...
            <div className="space-y-4">
              {/* Telephone */}
              <div className="flex items-center gap-3 rounded-xl border border-zinc-200/60 bg-white/50 p-3 sm:p-4 dark:border-zinc-800/80 dark:bg-zinc-900/30">
                <div className="rounded-lg bg-indigo-500/10 p-2 sm:p-2.5 text-indigo-500 shrink-0">
                  <Phone className="h-4 w-4 sm:h-5 sm:w-5" />
                </div>
                <div className="min-w-0">
                  <div className="text-xs font-semibold text-zinc-400 uppercase tracking-wider">Call Hotline</div>
                  <a href="tel:+0183-5031999" className="text-xs sm:text-sm font-bold text-zinc-850 dark:text-white hover:text-indigo-500 dark:hover:text-cyan-400 transition truncate block">
                    +0183-5031999
                  </a>
                </div>
              </div>
              ...
              <div className="flex items-center gap-3 rounded-xl border border-zinc-200/60 bg-white/50 p-3 sm:p-4 dark:border-zinc-800/80 dark:bg-zinc-900/30">
                ...
                <div className="min-w-0">
                  ...
                  <a href="mailto:info@srsolutions.com" className="text-xs sm:text-sm font-bold text-zinc-850 dark:text-white hover:text-indigo-500 dark:hover:text-cyan-400 transition truncate block">
              ...
              {!isSent ? (
                <form onSubmit={handleSend} className="space-y-4">
                  ...
                  <button
                    type="submit"
                    disabled={isSending}
                    className="flex w-full items-center justify-center gap-2 rounded-xl bg-indigo-600 py-3 text-sm font-semibold text-white shadow-md hover:brightness-110 active:scale-[0.99] disabled:opacity-50 transition duration-205 cursor-pointer"
                  >
                    {isSending ? (
                ...
                >
                  ...
                  <p className="mt-2 text-xs sm:text-sm text-zinc-600 dark:text-zinc-400 max-w-sm">
                    Thank you for reaching out, <span className="font-semibold text-indigo-500">{formData.name}</span>.
